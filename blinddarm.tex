...
\begin{table}[h]
	\centering
	\caption[Severity table for \acrshort{FMEA}]{Severity table for \acrshort{FMEA} \cite{FMEA_tables}}
...
\begin{table}[h]
	\centering
	\caption[Probability table for \acrshort{FMEA}]{Probability table for \acrshort{FMEA} \cite{FMEA_tables}}
