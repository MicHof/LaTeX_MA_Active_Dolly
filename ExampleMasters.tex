...
%\coverfigure{\includegraphics[width=\textwidth,height=0.7\paperheight,keepaspectratio]{figures/ExampleCover}}width=0.5\linewidth
\coverfigure{\includegraphics[width=1\linewidth,height=1\paperheight,keepaspectratio]{figures/ExampleCover}}
