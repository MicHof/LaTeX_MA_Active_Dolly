...
\firstabstract{To improve the dynamic behaviour of high capacity transport vehicles, the second semi-trailer \gls{CAN} be equipped with steered and braked axles. By improving the actuation and steering strategy, the combinations performance \gls{CAN} be increased drastically. 
