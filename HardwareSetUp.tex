...
\begin{figure*}[!htb]
	...
	\caption[System overview for sensors and signal path for \acrlong{ETS} legacy system by VSE]{System overview for sensors and signal path for \acrlong{ETS} legacy system by VSE}
