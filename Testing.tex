...
Figure \ref{fig:HIL002_front} shows the measurements of the ETS-CAN of the front axle of the dolly.\\
...
\begin{figure*}[h]
	...
	\caption{HIL test front axle details}
...
\begin{figure*}[h]
	...
	\caption{HIL test front axle comparison between VTM and ETS}
...
\begin{figure*}[h]
	...
	\caption{HIL test front axle comparison between VTM and ETS details}
