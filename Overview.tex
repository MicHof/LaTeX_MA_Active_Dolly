...
\begin{table}[!htb]
	\centering
	\caption[\acrlong{HCT} vehicles in different countries]{\acrlong{HCT} vehicles in different countries\cite{Vaegverket}\cite{HCT_vehicles_Australia}\Cite{HCT_vehicles_USA}\cite{HCT_vehicles_Canada}\Cite{HCT_vehicles_Mexico}}
