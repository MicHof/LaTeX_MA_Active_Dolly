...
Table \ref{tab:HCT vehicles_in_different_countries} shows the maximum length and weight of HCT vehicles in different countries.

\begin{table}[h]
	\centering
	\caption{HCT vehicles in different countries\cite{Vaegverket}\cite{HCT vehicles_Australia}\Cite{HCT vehicles_USA}\cite{HCT vehicles_Canada}\Cite{HCT vehicles_Mexico}}
	\label{tab:HCT vehicles_in_different_countries}
	\begin{tabular}{l|l|l|}
...
\cite{HCT vehicles_test_netherlands} \\
